...
export function LandingFeature() {
  return (
    <div className="w-full flex flex-col items-center">
      <div className="w-full rounded-lg overflow-hidden bg-slate-800 backdrop-blur-sm shadow-2xl border border-gray-300/50 p-4">
        <div className="flex flex-col gap-2">
          <h1 className="text-gray-200 text-3xl font-semibold mb-2">
            Improve Collision Detection #5991
          </h1>
          <div className="flex flex-col lg:flex-row items-center gap-2">
            <div className="w-full lg:w-auto">
              <div className="w-min bg-green-600 text-gray-200 px-3 py-1 rounded-full flex items-center gap-2">
            ...
            <span className="text-gray-300">
              ...
              <span className="bg-blue-500 text-gray-200 px-2 py-0.5 rounded-md mx-1 whitespace-nowrap">
                main
              </span>
              from
              <span className="bg-blue-500 text-gray-200 px-2 py-0.5 rounded-md mx-1 whitespace-nowrap">
      ...
      <div className="w-full rounded-lg overflow-hidden bg-slate-800 backdrop-blur-sm shadow-2xl border border-gray-300/50 p-4">
        <div className="grid lg:grid-cols-3 auto-rows-min gap-2">
          <div className="flex flex-col gap-1 border-b lg:border-b-0 lg:border-r border-gray-300/50 pr-2">
            <span className="font-semibold text-gray-200 whitespace-nowrap flex flex-row items-center gap-2">
      ...
      <div className="h-4 w-0.5 bg-stone-700/60"></div>
      <div className="w-full rounded-lg max-h-[170px] overflow-hidden bg-slate-800 backdrop-blur-sm shadow-2xl border border-gray-300/50 p-4 flex flex-col relative">
        <div className="absolute inset-x-0 bottom-0 h-16 bg-gradient-to-t from-slate-800 to-transparent pointer-events-none"></div>
        <span className="font-semibold text-gray-200 whitespace-nowrap flex flex-row items-center gap-2 pb-1">
        ...
        <div className="grid lg:grid-cols-2 xl:grid-cols-3 auto-rows-min gap-2">
          {hilTestCases.map((testCase) => (
            <div key={testCase} className="flex flex-col gap-1">
              <span className="text-gray-300">{testCase}</span>
            </div>
          ))}
        </div>
      </div>
      ...
      <div className="w-full rounded-lg max-h-[170px] overflow-hidden bg-slate-800 backdrop-blur-sm shadow-2xl border border-gray-300/50 p-4 flex flex-col relative">
        ...
        <div className="grid lg:grid-cols-3 auto-rows-min gap-2">
          {hilTestBeds.map((testBed) => (
            ...
            >
              <span className="text-gray-300">{testBed[0]}</span>
          ...
          <div className="relative w-full max-w-3xl">
            ...
            <div className="flex justify-between relative">
              ...
              <div className="flex flex-col items-center">
                <div className="w-10 h-10 rounded-full bg-green-500 text-gray-200 flex items-center justify-center z-10">
                  <CheckCircle className="w-6 h-6" />
                </div>
                <div className="text-center mt-2">
                  <span className="text-sm font-medium text-gray-200 sm:text-gray-600 block">
                    Detect Changes
                  </span>
              ...
              <div className="flex flex-col items-center">
                <div className="relative">
                  <div className="w-10 h-10 rounded-full bg-blue-500 text-gray-200 flex items-center justify-center z-10">
