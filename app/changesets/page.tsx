...
export default async function ChangesetsPage({
  ...
  const selectedChangeset = typeof searchParams?.changeset === "string" ? searchParams.changeset : undefined;
  ...
  return (
    <div className="p-6">
      ...
      <ChangesetsTable page={page} itemsPerPage={itemsPerPage} selectedChangeset={selectedChangeset} />
      <div className="mt-4">
        <Pagination>
          <PaginationContent>
            <PaginationItem>
