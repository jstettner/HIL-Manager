...
export type EnvironmentDetails = Database['public']['Views']['environment_details']['Row']
export type Testcase = Tables<'testcases'>
export type TestcaseDetails = Database['public']['Views']['testcase_details']['Row']
export type Changeset = Tables<'changesets'>
export type ChangesetSimple = Database['public']['Views']['changeset_simple']['Row']
export type Organization = Tables<'organizations'>
export type OrganizationMember = Tables<'organization_members'>
export type UserOrganization = Database['public']['Views']['user_organizations']['Row']
export type UserCurrentOrganization = Database['public']['Views']['user_current_organization']['Row']
